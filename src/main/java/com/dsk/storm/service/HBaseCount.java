...
import com.dsk.storm.function.HBaseCountETL;
...
public class HBaseCount {
    public static void main(String[] args) throws InvalidTopologyException, AuthorizationException, AlreadyAliveException {
        ...
        TridentKafkaConfig tridentKafkaConfig =
                new TridentKafkaConfig(hosts, Constants.TOPIC_UPMATCH, UUID.randomUUID().toString());
...
//        StateFactory state = KuduState2.transactional("namenode");
        ...
        StormSubmitter.submitTopologyWithProgressBar(Constants.TOPIC_UPMATCH, conf, topology.build());
    }
}
